    ...
    <section id="about" className="section-padding px-6 bg-card">
      <div className="content-width scroll-mt-56">
        ...
        <div className="prose-editorial space-y-6">
          ...
          <p>My role is to provide that perspective, working as a thinking partner to leaders who are responsible for making difficult things happen inside complex organisations. Someone who can move between the detail and the wider system around it. Also close enough to the work to understand the reality of decisions, not just the frameworks used to describe them.</p>
          
          <p>I work best with experienced leaders who are already capable and thoughtful but find themselves dealing with a situation where pushing harder is no longer the answer. In those moments, clearer thinking can unlock progress surprisingly quickly.</p>
        </div>
      </div>
    </section>);
